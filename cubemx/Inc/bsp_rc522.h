...
#define     RECORD_ADDR     0x05    //记录信息的M1卡块地址

extern SPI_HandleTypeDef RC522spi;
extern device rc522;
...
uint8_t rc522_open(const char * pathname , int flags);
uint8_t rc522_read(int fd,void*buf,int count);
uint8_t rc522_write(int fd,void*buf,int count);
#endif
